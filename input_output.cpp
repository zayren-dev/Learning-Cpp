...
int main()
{
    ...
    std::cout << "\n" << "Enter a floating decimal point number: "; // here we printed a new message to the console asking the user to enter a number
    std::cin >> x; // here we took input from the user and stored it in the variable x
    std::cout << "You entered: " << x; // here we printed the value of x to the console
  return 0;
